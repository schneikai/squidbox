...
Builds run from a cloud workspace. For the full procedure, see `README.md` → "Build & preview" and "Building from the cloud (no Mac)", and the `build` skill for the headless runbook. Invariants:
